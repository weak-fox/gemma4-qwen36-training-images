...
SCRIPT_PATH="${SCRIPT_PATH:-$WORKDIR/train_gemma4_31b_qlora.py}"

export https_proxy="${https_proxy:-http://105.100.31.173:7897}"
export http_proxy="${http_proxy:-http://105.100.31.173:7897}"
export all_proxy="${all_proxy:-socks5://105.100.31.173:7897}"
